...
<head>
	...
	<!-- Standard Favicon -->
	<link rel="icon" type="image/x-icon" href="${pageContext.request.contextPath }/views/template/${pageContext.request.contextPath }/views/template/${pageContext.request.contextPath }/views/template/images/hotel.png" />
	
	<!-- For iPhone 4 Retina display: -->
	<link rel="apple-touch-icon-precomposed" sizes="114x114" href="${pageContext.request.contextPath }/views/template/${pageContext.request.contextPath }/views/template/${pageContext.request.contextPath }/views/template/images//apple-touch-icon-114x114-precomposed.png">
	
	<!-- For iPad: -->
	<link rel="apple-touch-icon-precomposed" sizes="72x72" href="${pageContext.request.contextPath }/views/template/${pageContext.request.contextPath }/views/template/${pageContext.request.contextPath }/views/template/images//apple-touch-icon-72x72-precomposed.png">
	
	<!-- For iPhone: -->
	<link rel="apple-touch-icon-precomposed" href="${pageContext.request.contextPath }/views/template/${pageContext.request.contextPath }/views/template/${pageContext.request.contextPath }/views/template/images//apple-touch-icon-57x57-precomposed.png">
	...
	<header class="header-section container-fluid no-padding">
		...
		<div class="top-header container-fluid no-padding">
			...
			<div class="container">
				...
				<div id="top_list" class="col-md-5 col-sm-6 col-xs-12 header-social"> <a href="selfcenter.jsp">个人中心</a>
					...
					<li class="col-md-4 col-sm-4 col-xs-6 design">
						<div class="content-image-block">
							...
							<div class="content-block-hover">
								...
								<a href="${pageContext.request.contextPath }/views/gallery-single.jsp" title="Link"><i class="fa fa-external-link"></i></a>
							</div>
						</div>
					</li>
