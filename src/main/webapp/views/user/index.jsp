...
<script src="${pageContext.request.contextPath }/views/user/js/index.js" type="text/javascript"></script>
<script src="${pageContext.request.contextPath }/views/user/js/highcharts/highcharts.js" type="text/javascript"></script>
