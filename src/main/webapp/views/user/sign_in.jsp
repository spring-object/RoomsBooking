...
<div id='wrapper'>
    <div class='application'>
        <div class='application-content'>
            <a href="${pageContext.request.contextPath }/user/login"><div class='icon-heart'></div>
                <span>客房预订系统</span>
            </a>
        </div>
    </div>
    <div class='controls'>
        ...
        <div class='form-wrapper'>
            ...
            <form accept-charset="UTF-8" action="${pageContext.request.contextPath }/user/" method="get" /><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /></div>
                <div class='row-fluid'>
                ...
                <button class="btn btn-block" name="button" type="submit">登陆</button>
            </form>
