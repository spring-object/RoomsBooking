...
<head>
	...
	<title>公寓详情——酒店预订</title>

	<!-- Standard Favicon -->
	<link rel="icon" type="image/x-icon" href="${pageContext.request.contextPath }/views/template/${pageContext.request.contextPath }/views/template/${pageContext.request.contextPath }/views/template/${pageContext.request.contextPath }/views/template/images/hotel.png" />
	
	<!-- For iPhone 4 Retina display: -->
	<link rel="apple-touch-icon-precomposed" sizes="114x114" href="${pageContext.request.contextPath }/views/template/${pageContext.request.contextPath }/views/template/${pageContext.request.contextPath }/views/template/${pageContext.request.contextPath }/views/template/images//apple-touch-icon-114x114-precomposed.png">
	
	<!-- For iPad: -->
	<link rel="apple-touch-icon-precomposed" sizes="72x72" href="${pageContext.request.contextPath }/views/template/${pageContext.request.contextPath }/views/template/${pageContext.request.contextPath }/views/template/${pageContext.request.contextPath }/views/template/images//apple-touch-icon-72x72-precomposed.png">
	
	<!-- For iPhone: -->
	<link rel="apple-touch-icon-precomposed" href="${pageContext.request.contextPath }/views/template/${pageContext.request.contextPath }/views/template/${pageContext.request.contextPath }/views/template/${pageContext.request.contextPath }/views/template/images//apple-touch-icon-57x57-precomposed.png">
		...
		<div class="page-banner gallerysingle-banner container-fluid no-padding">
			<div class="banner-content">
				...
				<ol class="breadcrumb">
					...
					<li><a href="${pageContext.request.contextPath }/views/gallery.jsp" title="Gallery">公寓</a></li>							
					<li class="active">酒店详情页</li>
				</ol>
			</div>
		</div><!-- Page Banner /- -->
		...
		<div class="gallery-single container-fluid no-padding">
			...
			<div class="container">
				<div class="flexslider gallery-details-full">
					<ul class="slides">
						<li>
							<img src="${pageContext.request.contextPath }/views/template/images/large-thumb.jpg" alt="large-thumb">
						</li>
						<li>
							<img src="${pageContext.request.contextPath }/views/template/images/large-thumb.jpg" alt="large-thumb">
						</li>
				...
				<div class="flexslider gallery-details-thumb">
					<ul class="slides">
						<li>
							<img src="${pageContext.request.contextPath }/views/template/images/thumb-1.jpg" alt="thumb" />
						</li>
						<li>
							<img src="${pageContext.request.contextPath }/views/template/images/thumb-2.jpg" alt="thumb" />
						</li>
						<li>
							<img src="${pageContext.request.contextPath }/views/template/images/thumb-3.jpg" alt="thumb" />
						</li>
						<li>
							<img src="${pageContext.request.contextPath }/views/template/images/thumb-1.jpg" alt="thumb" />
						</li>
				...
				<div class="information-section">
					<div class="row">
						<div class="col-md-5 col-sm-6 col-xs-6">
							<div class="info-box">
								<h3>名字<span>阳光沙滩3号营地</span></h3>
								<h3>位置<span>惠州-双月湾</span></h3>
								<h3>价格<span>￥500/天</span></h3>
							</div>
						</div>
						<div class="col-md-7 col-sm-6 col-xs-6">
							<h3 class="info-heading">详情</h3>
							<p class="info-content">坐拥双湾三海世界奇景、紧靠亚洲大陆架上唯一海龟产卵基地，作为6年醇熟大盘，配套齐全，度假氛围浓郁。坐拥双湾三海世界奇景、紧靠亚洲大陆架上唯一海龟产卵基地，作为6年醇熟大盘，配套齐全，度假氛围浓郁。惠州双月湾因形状鸟瞰像两轮新月，故名双月湾。位于惠州市惠东县港口滨海旅游度假区管委会（原港口镇）。双月湾共分两湾，由大亚湾和虹海湾相邻的两个半月形组成。</p>
						</div>
					</div>
				</div>
				<div class="description-section">
					<h3 class="info-heading">描述</h3>
					<p class="info-content">惠州双月湾檀悦豪生温泉度假酒店选址于双月湾绵延海岸线上风景最为秀丽、最为人所渴慕的绝佳目的地之一，紧邻全球大陆架唯一的国家级海龟自然保护区。

惠州双月湾檀悦豪生温泉度假酒店被葱郁的热带园林所拥抱，可全方位观赏壮丽海景及享受延绵不断晶莹洁白近300米私属沙滩。酒店成功入选美国权威旅行杂志——《CN旅行家》 （Conde Nast Traveller），是中国唯一上榜全球十大度假酒店名单的度假酒店。 
</p>
					<p class="info-content">
惠州双月湾檀悦豪生温泉度假酒店是美国温德姆豪生集团旗下的一家奢华型海滨度假酒店。由迪拜大师Jason设计，以“海浪拍打沙滩形成的五朵水滴”为创意理念，形成标志性建 筑“水滴酒店”。酒店拥有417间海景客房、百米高层直瞰大海无边际天顶泳池、百米高空“檀悦”空中SPA以及无可比拟的华南最大酒店泳池群。为来自全球对生活独具品位的旅行 者提供超越期待的体验。	</p>
				</div>
			</div><!-- Container /- -->
		</div><!-- Gallery Single -->
	</main>
