				...
				<div class="container">
					...
					<div class="col-md-8 col-sm-8 col-xs-6">
						<div id="datepicker3" class="input-group col-md-3 col-sm-3 col-xs-12">
							<input id="start_time" name='date_in' class="form-control datepicker" placeholder="入住时间" type="text">
							<span class="input-group-addon add-on">
								<span class="glyphicon glyphicon-calendar"></span>
							</span>
						</div>
						<div id="datepicker4" class="input-group col-md-3 col-sm-3 col-xs-12">
							<input id="end_time" name='date_out' class="form-control datepicker" placeholder="退房时间" type="text">
							<span class="input-group-addon add-on">
								<span class="glyphicon glyphicon-calendar"></span>
							</span>
						</div>
						<a class="book-now" id="book-now" style="cursor:pointer" >马上预订</a>
					</div>
				</div><!-- Container /- -->
...
<!--  房间详情-->
	<!-- Offer Section -->
		<div style="margin-top: -50px;" class="offer-section container-fluid">
			<!-- Container -->
			<div class="container">
				<!-- Section Header -->
				...
				<!-- 房间详情 -->
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="offer-box">
							<div class="offer-content" style="margin:auto;text-align:center">
								<input id="rid" type="hidden" value="${room.rid }">
								<h5>房间名称：${room.rname }</h5>
								<p style="font-size:22px">房间类型：${room.type }</p>
								<p style="font-size:22px">房间描述：${room.info }</p>
								<p style="font-size:22px">房间设备：${room.equipment }</p>
								<span style="font-size:18px">房价：${room.price }￥/晚起</span>
								<h5>房间图片</h5>
							</div>
							<div class="offer-content" style="margin-top:-25px">
							<c:forEach var="picture" items="${pictures }">
								<i><img src="${pageContext.request.contextPath }/views/images/rooms/${picture.src }" style="margin-bottom:10px" width="16.25%" height="200px" alt="offer"></i>
							</c:forEach>
							</div>
						</div>
					</div>
	...
	<!-- 自定义js -->
	<script src="${pageContext.request.contextPath }/views/template/js/showOneRoom.js"></script>
</body>
</html>
